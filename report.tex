...
personalization and targeted advertising. Even more, it helps to understand users' needs and helps and provides real world input to better organization of content and structure. Having on hand the web server log files of a web site can provide important insight to the users' behavior.
...
\[
 \overset{2.2s}{A} \rightarrow \overset{2.2s}{B} \rightarrow \overset{2.2s}{C}
\]
