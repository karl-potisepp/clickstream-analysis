...
Sequential patterns can be used to see how much users spend time on each page. If we have some kind of frequent sequence  where user traverses the following path: $page1 \rightarrow page2 \rightarrow page3$. For this pattern, we can search all transaction where it occurs and calculate times
